var version = "1.8.8-setvolume ads fix-truex";
...
window.cmgRewardAds = function () {
  ...
  truex_options = {
    ...
    //test hash
    // 'partner_config_hash': '83f879b26797c723882473d6435e6361c105d86b'
   };
   

   //0d188638b7d82efe6e2e696c3ab3e06d88e35cbf  other partner hash
  ...
  truex.client(truex_options, function (client) {
    client.requestActivity(function (activity) {
      if (!activity || !activity.window_url) {
        console.log("No TrueX ad available — falling back to Playwire.");
