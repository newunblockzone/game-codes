...
adsenseScript.setAttribute('data-ad-frequency-hint', '90s');
adsenseScript.setAttribute('crossorigin', 'anonymous');
adsenseScript.setAttribute('data-ad-channel', '8195891072');
...
function CallInterstitialAdsJs() {
    console.log("Interstitial Ads", cnt);
...
function CallInterstitialAdsPauseJs() {
    console.log("Interstitial Ads - Pause Menu")
    adBreak({
        type: 'pause',
        name: 'pause-game',
        beforeAd: () => {
...
function pauseAudioBeforeAds() {
    myGameInstance.SendMessage('RHMAdsManager', 'pauseAudio');
}
